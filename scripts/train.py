...
if __name__ == '__main__':
    ...
    train(f"{ROOT}/data/raw/sp500/DLTR.csv", run_all_modes=["PPO_LargeAction"])
    train(f"{ROOT}/data/raw/sp500/DLTR.csv", run_all_modes=["A2C"])
    train(f"{ROOT}/data/raw/sp500/DLTR.csv", run_all_modes=["DRQN" ])
    train(f"{ROOT}/data/raw/sp500/DLTR.csv", run_all_modes=["PPO", "PPO_LargeAction", "A2C", "DRQN" ])
